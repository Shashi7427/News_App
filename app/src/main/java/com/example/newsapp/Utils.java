...
public final class Utils {
    ...
    private static List<News> extractFeatureFromJson(String earthquakeJSON) {
        ...
        try {
            ...
            int  l = response.getInt("pageSize");
            ...
            for (int i = 0; i < l; i++){
                ...
                String link = feature.getString("webUrl");
                ...
                if (tags.length() != 0){
                    ...
                    author = tag.getString("firstName");
                    author += " ";
                    author += tag.getString("lastName");
                }


                if (author != null)
                    list.add(new News(title,section,date,link,author));
                else
                    list.add(new News(title,section,date,link));
            }
            return list;
